...
class UnsupervisedAdaptiveNormalization(layers.Layer):
    def __init__(self, num_components, epsilon=1e-3, momentum=0.9, **kwargs):
        self.num_components = num_components
        self.epsilon = epsilon
        self.momentum = momentum
        super(UnsupervisedAdaptiveNormalization, self).__init__(**kwargs)
    ...
    def build(self, input_shape):
        ...
        super(UnsupervisedAdaptiveNormalization, self).build(input_shape)
    ...
    def config(self):
        config = super(UnsupervisedAdaptiveNormalization, self).get_config().copy()
        config.update(
            {
...
class UnsupervisedAdaptiveNormalization(tf.keras.layers.Layer):
    def __init__(self, num_components, epsilon=1e-3, momentum=0.9, **kwargs):
        self.num_components = num_components
        self.epsilon = epsilon
        self.momentum = momentum
